...
public class failLogin {
	WebDriver driver;
	 ...
	 public void user_should_be_open_url() {
	 ...
	 public void user_input_invalid_uname_and_pwd() throws Exception {
	     driver.findElement(By.id("user-name")).sendKeys("helloworld");
	     Thread.sleep(500);
	     driver.findElement(By.id("password")).sendKeys("hihihihihi");
	     Thread.sleep(500);
	 }
